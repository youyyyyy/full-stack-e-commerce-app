...
export class CheckoutComponent implements OnInit {
  ...
  // vars for credit card info
  creditCardYears: number[] = [];
  creditCardMonths: number[] = [];

  // vars for populate countries and states
  countries: Country[] = []
  ...
  // for shippingAddress validation
