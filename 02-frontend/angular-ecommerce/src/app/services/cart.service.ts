...
export class CartService {
  ...
  // persist cart item
  // storage: Storage = sessionStorage; // session storage, data will be lost if we close the browser
  storage: Storage = localStorage; // data is persisted and survives browser starts
  ...
  addToCart(theCartItem: CartItem) {
    ...
    if (this.cartItems.length > 0) {
      ...
      // returns the first element that passes else return undefined
